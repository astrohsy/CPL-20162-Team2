...
void printCallibrationResult(int n_boards, Size imageSize, double reproj_err, Mat intrinsic_Matrix, Mat distortion_coeffs)
{
	char str[MAXSTR];
...
void callibration(int board_w, int board_h, int n_boards, float measure)
{
	char str[MAXSTR];
	...
	printCallibrationResult(n_boards, imageSize, reproj_err, intrinsic_Matrix, distortion_coeffs);
}